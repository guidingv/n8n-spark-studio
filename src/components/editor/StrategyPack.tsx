          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Badge className={getPriorityColor(selectedStrategyData.priority)}>
                {selectedStrategyData.priority} priority
              </Badge>
            </div>
            ...
            {isExpanded && (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>{selectedStrategyData.audience}</span>
                    </div>
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>This content will be aligned with the selected strategy objectives</span>
                </div>
              </>
            )}
          </div>
